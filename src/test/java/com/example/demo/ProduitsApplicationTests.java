...
class ProduitsApplicationTests {
	...
	/*
	 * @Test public void testFindByNomProduitContains() { Page<Produit> prods =
	 * produitService.getAllProduitsParPage(0, 2);
	...
	public void testfindByNomPrix() {
		List<Produit> prods = produitRepository.findByNomPrix("PC Dell", 900.0);
		for (Produit p : prods) {
			System.out.println(p);
		}
